...
subprojects {
    ...
    dependencies {
        ...
        implementation("com.fasterxml.jackson.module:jackson-module-kotlin:2.13.0") //Jackson version
        implementation("com.fasterxml.jackson.core:jackson-core:2.13.0") //Jackson version
